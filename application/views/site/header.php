    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
				...
				<a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="<?php echo base_url('assets/assets/img/navbar-logo.svg --erradoa-- " alt=""');?>"/>TechManager</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?php echo base_url('login');?>">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
